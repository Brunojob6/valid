...
const Question = (props: Props) => (
	<FinalForm
		...
		initialValues={{
			...
			period: props.statusSession == "S" ||props.statusSession == "A" ? '1' : '2'
		}}
		render={({
			handleSubmit,
		}) => (
			<React.Fragment>
				<Field
					placeholder={props.statusSession == "S" || props.statusSession == "A" ? "Você deseja realmente iniciar a aula?" : "Você deseja realmente finalizar a aula?"}
